...
const SignupPage = ({ setIsAuthenticated }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://cinemaconnect.onrender.com/api/auth/signup', {
        method: 'POST',
        headers: {
  ...
  const handleOtpVerify = async (e) => {
    ...
    setOtpLoading(true);
    try {
      const response = await fetch('https://cinemaconnect.onrender.com/api/auth/verify-signup-otp', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
